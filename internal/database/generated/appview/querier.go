...
type Querier interface {
	...
	CleanupOldProcessedEvents(ctx context.Context) error
	...
	GetAppViewSubforumBySlug(ctx context.Context, slug string) (*GetAppViewSubforumBySlugRow, error)
	...
	GetSubforumByURI(ctx context.Context, atprotoUri *string) (*AppviewSubforum, error)
	...
	ListAppViewSubforums(ctx context.Context, arg *ListAppViewSubforumsParams) ([]*ListAppViewSubforumsRow, error)
	...
	ListCommentsByPostWithUserVotes(ctx context.Context, arg *ListCommentsByPostWithUserVotesParams) ([]*ListCommentsByPostWithUserVotesRow, error)
