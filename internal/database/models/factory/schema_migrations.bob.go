...
type SchemaMigrationTemplate struct {
	ID        func() string
	AppliedAt func() sql.Null[time.Time]
...
func (m schemaMigrationMods) RandomizeAllColumns(f *faker.Faker) SchemaMigrationMod {
	return SchemaMigrationModSlice{
		SchemaMigrationMods.RandomID(f),
		SchemaMigrationMods.RandomAppliedAt(f),
	}
}

// Set the model columns to this value
func (m schemaMigrationMods) ID(val string) SchemaMigrationMod {
...
func (m schemaMigrationMods) IDFunc(f func() string) SchemaMigrationMod {
	return SchemaMigrationModFunc(func(_ context.Context, o *SchemaMigrationTemplate) {
		o.ID = f
	})
}
...
func (m schemaMigrationMods) UnsetID() SchemaMigrationMod {
	return SchemaMigrationModFunc(func(_ context.Context, o *SchemaMigrationTemplate) {
		o.ID = nil
	})
}
...
func (m schemaMigrationMods) RandomID(f *faker.Faker) SchemaMigrationMod {
	return SchemaMigrationModFunc(func(_ context.Context, o *SchemaMigrationTemplate) {
		o.ID = func() string {
...
// Set the model columns to this value
func (m schemaMigrationMods) AppliedAt(val sql.Null[time.Time]) SchemaMigrationMod {
	return SchemaMigrationModFunc(func(_ context.Context, o *SchemaMigrationTemplate) {
		o.AppliedAt = func() sql.Null[time.Time] { return val }
	})
}

// Set the Column from the function
func (m schemaMigrationMods) AppliedAtFunc(f func() sql.Null[time.Time]) SchemaMigrationMod {
	return SchemaMigrationModFunc(func(_ context.Context, o *SchemaMigrationTemplate) {
		o.AppliedAt = f
	})
}
...
// Clear any values for the column
func (m schemaMigrationMods) UnsetAppliedAt() SchemaMigrationMod {
	return SchemaMigrationModFunc(func(_ context.Context, o *SchemaMigrationTemplate) {
		o.AppliedAt = nil
	})
}
...
func (m schemaMigrationMods) RandomAppliedAt(f *faker.Faker) SchemaMigrationMod {
	return SchemaMigrationModFunc(func(_ context.Context, o *SchemaMigrationTemplate) {
		o.AppliedAt = func() sql.Null[time.Time] {
			if f == nil {
				f = &defaultFaker
			}
...
func (m schemaMigrationMods) RandomAppliedAtNotNull(f *faker.Faker) SchemaMigrationMod {
	return SchemaMigrationModFunc(func(_ context.Context, o *SchemaMigrationTemplate) {
		o.AppliedAt = func() sql.Null[time.Time] {
			if f == nil {
				f = &defaultFaker
